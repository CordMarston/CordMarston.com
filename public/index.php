<html>
<head>
<title>Cord Marston - Full Stack Developer</title>
	...
	<div class="container">
		<div class="row py-3">
			<div class="col-sm-3 text-white">
				<img src="images/cord-marston-name-4.png" alt="Cord Marston" class="img-name">
			</div>
			<div class="col-sm-9 text-white text-sm-right align-self-center">
				I am constantly looking for work. If you are looking for a free quote, please contact me.
			</div>
		</div>
	</div>
</section>
...
<section class="top-project row-grey py-5 mt-4">
	<div class="container mt-4">
		<div class="row py-5">
			...
			<h2 class="font-weight-bold"><a href="#">Z Networks Dashboard</a></h2>
			<p>The Z Networks Dashboard is all-in-one web software tool that allows Z Networks to offer a completely custom IT experience.</p>
			<p>The dashboard consists of many tools and systems including:</p>
			<ul>
				<li>Helpdesk & Ticketing</li>
				<li>Employee Timeclock</li>
				<li>Client Device Management</li>
				<li>Billing - Invoicing, Send / Recieve Payments / Inventory</li>
				<li>Human Resources - PTO / Payroll / Employee Management</li>
				<li>Client Mapping & On-Site Scheduling</li>
			</ul>
	...
	<div class="container">
		<div class="row py-5">
			...
			<div class="col-sm order-sm-2">
				...
				<p>Over the course of the applications time being live adjustments have been made to include monetization and analytics. On average, the application passively generates $20 a month.</p>
...
<section class="third-project row-white py-3">
	<div class="container">
		<div class="row py-5">
			<div class="col-sm">
				<img src="images/gameguidehq-stats.PNG" alt="GameGuideHQ.com Analytics" class=" w-100 cust-image-wide shadow"> 
			</div>
			<div class="col-sm pt-xl-0 pt-4">
				<h2 class="font-weight-bold"><a href="https://gameguidehq.com" target="_blank">GameGuideHQ.com</a></h2>
				<p>GameGuideHQ.com is a personal blog I do for fun. The site has a custom built wordpress theme off the Hueman framework. In my spare time I like to tinker with the SEO, layout, ad placement and such. The site started to take off in early 2019 when it started getting over 100,000 users a month.</p>
				<p>After getting traction the website has been featured on Dotesports, Kotaku and other esports industry leading websites.</p>
				<p>Not only does GameGuideHQ.com post news articles related to gaming, it also has a historical database of social media growth of popular esports teams and players. The database uses Facebook, YouTube, Twitch & Instagram APIs to pull social media statistics for brands to track growth.</p>
				<p class="text-center pt-3"><img src="images/wordpress-logo.png" alt="Wordpress" class="img-software d-inline px-2"><img src="images/php-logo.png" alt="PHP" class="img-software d-inline px-2"><img src="images/yoast-icon.webp" alt="Wordpress Plugin - Yoast SEO" class="img-software d-inline px-2"><img src="images/google-news-icon.png" alt="Google News Publisher" class="img-software d-inline px-2"><img src="images/adsense-logo.png" alt="Adsense" class="img-software d-inline px-2"></p>
			</div>
		</div>
	</div>
</section>
<section class="row-grey-bottom py-3">
	<div class="container">
		<div class="row py-5">
			<div class="col-sm text-center align-self-center order-sm-2">
				<img src="images/powerstroke_customs_logo.png" alt="Powerstroke Customs" class="cust-image">
			</div>
			<div class="col-sm order-sm-1">
				<h2 class="font-weight-bold"><a href="https://powerstrokecustoms.com" target="_blank">Powerstroke Customs</a></h2>
				<p>Custom built a website for a friends local business. The website utilizies Wordpress as a backend with Woocommerce to sell diesel / automotive products.</p>
				<p>The website was fully customized by implementing layout changes to the "Business Street" theme.</p>
				<p>Website uses Woocommerce for selling, Contact Form 7 for emailing, SMTP2GO to bypass shared hosting email settings, and a few other plugins to fit the business owners needs.</p>
				<p class="text-center pt-3"><img src="images/wordpress-logo.png" alt="Wordpress" class="img-software d-inline px-2"><img src="images/php-logo.png" alt="PHP" class="img-software d-inline px-2"><img src="images/yoast-icon.webp" alt="Wordpress Plugin - Yoast SEO" class="img-software d-inline px-2"><img src="images/woocommerce.png" alt="Woocommerce" class="img-software d-inline px-2"></p>
			</div>
			
		</div>
	</div>
</section>
<section class="contact-about row-dark-final py-1 bg-cust-dark">
	<div class="container">
		<div class="row contact-drop">
			<div class="col text-white">
			<h2 class="font-weight-bold text-center">Contact</h2>
			<p class="text-center text-uppercase">I'm available for work, get in touch!</p>
			<form id="cForm">
			  <div class="row">
				<div class="col-sm">
					<label for="input_name">Name</label>
					<input type="text" class="form-control" id="input_name" placeholder="Name" name="name" style="border-radius:0!important;">
				</div>
				<div class="col-sm">
					<label for="input_email">Email address</label>
					<input type="email" class="form-control" id="input_email" placeholder="Email Address" name="email" style="border-radius:0!important;">
				</div>
			  </div>
			  <div class="row py-3">
				<div class="col-sm">
					<label for="input_desc">Message</label>
					<textarea name="message" id="input_desc" placeHolder="Enter message" class="w-100" rows="5"></textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-sm text-right">
			  <p class="btn btn-primary" id="cButton">Submit</p>
			  </div>
			 </div>
			</form>
			</div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-143002474-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-143002474-1');
</script>
